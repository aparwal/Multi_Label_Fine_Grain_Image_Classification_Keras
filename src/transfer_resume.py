...
#SBATCH -n 4
#SBATCH -p gpu
#SBATCH -o train-deeper150-resume2.out
#SBATCH -t 22:20:00
#SBATCH --gres=gpu:2
#SBATCH --mem=106000
...
model_final=load_model('inceptionv3_21.04-0.14.h5')
...
checkpoint = ModelCheckpoint("inceptionv3_21.{epoch:02d}-{loss:.2f}.h5", monitor='loss', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
early = EarlyStopping(monitor='loss', min_delta=0.000, patience=20, verbose=1, mode='auto')
